...
#M.update_gso() # вычислить все интересные матрицы (R-фактор, mu, ...)
#print(M.get_r(1,1))
...
M_transf = GSO.Mat(Ac, float_type="qd", U = U, UinvT = UinvT) #U --  матрица преобразования от A к LLL-редцуцированному Ac
